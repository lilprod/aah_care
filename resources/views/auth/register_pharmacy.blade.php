...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>AAH+ - Pharmacy Register</title>
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-md-12 col-lg-7 login-right">
                                        <div class="login-header">
                                            <h3>{{ isset($url) ? ucwords($url) : ""}} Register<a href="{{route('register_doctor')}}">  Are you Doctor? </a>  <a href="{{route('register')}}"> Are you Patient? &nbsp; &nbsp;</a> </h3>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Pharmacy Name">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control @error('registration') is-invalid @enderror" name="registration" id="registration" value="{{ old('registration') }}" required autocomplete="registration" placeholder="Registration N°">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control floating @error('creation_date') is-invalid @enderror" name="creation_date" id="creation_date" value="{{ old('creation_date') }}" required autocomplete="creation_date">
