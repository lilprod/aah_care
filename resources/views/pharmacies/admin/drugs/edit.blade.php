...
<div class="row">
    <div class="col-lg-6 offset-lg-3">
        <form method="POST" action="{{ route('pharmacydrugs.update', $pharmacydrug->id) }}" enctype="multipart/form-data">
        	{{ csrf_field() }}
            {{ method_field('PATCH') }}
            ...
            <div class="row form-row">
                        ...
                        <div class="form-group">
                            <select class="form-control select" name="drug_id">
                                @foreach($drugs as $drug)
                                    <option value="{{$drug->id}}" {{ ($pharmacydrug->drug_id === $drug->id) ? 'selected' : '' }}>{{$drug->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="q_minimum" value="{{$pharmacydrug->q_minimum}}" id="q_minimum">
                    </div>
                </div>
                 ...
                 <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="number" id="unit_ht" name="unit_ht" value="{{$pharmacydrug->unit_ht}}" class="form-control">
                    </div>
                </div>
                 ...
                 <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="number" id="unit_tt" name="unit_tt" value="{{$pharmacydrug->unit_tt}}" class="form-control">
                    </div>
                </div>
                 ...
                 <div class="col-12 col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="discount" name="discount" value="{{$pharmacydrug->discount}}" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea cols="30" rows="4" class="form-control" name="description">{{$pharmacydrug->description}}</textarea>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-12">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="status" id="product_active" value="1" {{ ($pharmacydrug->status == 1) ? 'checked' : '' }}>
                        <label class="form-check-label" for="product_active">
                        Actif
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="status" id="product_inactive" value="0" {{ ($pharmacydrug->status == 0) ? 'checked' : '' }}>
