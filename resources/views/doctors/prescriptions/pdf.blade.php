                            ...
                            <tbody>
                                <tr>
                                    <td class="border-0 pl-0">
                                        ...
                                        <p>Issue : <strong>20/07/2019</strong></p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="px-0">
                                    ...
                                    <p class="seller-name">
                                       Invoice From <strong>Dr. {{$prescription->doctor->name }} {{$prescription->doctor->firstname}}</strong>
                                    </p>
                                    ...
                                    <p class="seller-phone">
                                        Phone : {{$prescription->doctor->phone_number }}
                                    </p>
                                ...
                                <td class="px-0">
                                    ...
                                    <p class="buyer-name">
                                        Invoice To <strong>{{$prescription->patient->name }} {{$prescription->patient->firstname}}</strong>
                                    </p>
                                    ...
                                    <p class="buyer-phone">
                                        Tel : {{$prescription->patient->phone_number }}
                                    </p>
                                </td>
                            </tr>
                        </tbody>
