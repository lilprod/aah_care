				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-8 col-12">
							<h2 class="breadcrumb-title">Our Pharmacies <span style="color: #26a9e166">+</span></h2>
							<!--<h2 class="breadcrumb-title">{{count($pharmacies)}} matches found for : Pharmacy In United States</h2>-->
						</div>
			...
			<div class="content">
				<div class="container-fluid">
					 ...
					 <div class="row">
						...
						<div class="col-md-12 col-lg-4 col-xl-1 theiaStickySidebar">
