...
@section('content')
					...
					<div class="col-md-6 col-xl-4 col-sm-12">
						...
						<div class="blog grid-blog">
							...
							<div class="row pt-3">
								...
								<div class="col text-right"><a href="javascript:void(0);" class="text-danger" data-toggle="modal" data-target="#deleteNotConfirmModal" onclick="postData({{ $post->id}})"><i class="far fa-trash-alt"></i> Active</a></div>
							</div>
						</div>
						<!-- /Blog Post -->
	...
	<div class="modal fade" id="deleteNotConfirmModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<form action="" id="ActiveForm" method="post">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="acc_title">Active Post?</h5>
						...
						<div class="modal-body">
							{{ csrf_field() }}
				            {{ method_field('POST') }}
							<p id="acc_msg">This Post will be activate. Do you agree?</p>
						</div>
...
<script>
	function postData(id)
     {
         var id = id;
         var url = '{{ route("admin_activate_post", ":id") }}';
