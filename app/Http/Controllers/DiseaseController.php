...
class DiseaseController extends Controller
{
    ...
    public function postSearch(Request $request)
    {
        ...
        if (count($diseases) > 0){
            ...
            return view('pages.answers', compact('diseases', 'nb'));

        }

        return view('pages.answers', compact('nb'))->with('error', 'No Disease found for your query. Try to search again!');
    }
    ...
    public function index()
    {
        ...
        foreach ($diseases as $disease) {
         ...
         return view('doctors.diseases.index')->with('diseases', $diseases);
    }
    ...
    {
        return view('doctors.diseases.create');
    }
    ...
    public function store(Request $request)
    {
       ...
       //$historique->save();
        return redirect()->route('diseases.index')
                        ->with('success', 'Disease recorded successfully.');
    ...
    public function show($id)
    {
        ...
        return view('doctors.diseases.show', compact('disease'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('doctors.diseases.edit', compact('disease'));
    }
